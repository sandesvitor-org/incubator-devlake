...
// func init() {
// 	RegisterSubtaskMeta(&CollectPokemonTypeMovesMeta)
// }

// // const RAW_POKEMON_TYPE_MOVES_TABLE = "pokemon_type_moves"

// var CollectPokemonTypeMovesMeta = plugin.SubTaskMeta{
// 	Name:             "collectPokemonTypeMoves",
// 	EntryPoint:       CollectPokemonTypeMoves,
// 	EnabledByDefault: true,
// 	Description:      "Collect Pokemon type moves (i.e. 'normal' type has 'slan' move)",
// 	DomainTypes:      []string{plugin.DOMAIN_TYPE_TICKET},
// }

// func CollectPokemonTypeMoves(taskCtx plugin.SubTaskContext) errors.Error {
// 	logger := taskCtx.GetLogger()
// 	logger.Info("collect pokemon type moves")
// 	data := taskCtx.GetData().(*PokemonTaskData)

// 	collector, err := api.NewApiCollector(
...
// 	logger.Info("depois do collector")

// 	if err != nil {
// 		logger.Error(err, "collect pokemon type move error")
// 		return err
// 	}
